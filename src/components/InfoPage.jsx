...
const InfoPage = () => {
  return (
    <div>
      <Page>
        <div className='text-2xl p-4 bg-green-800 text-white'>Information</div>
        <div className='' style={{overflow: 'scroll'}}>
          ...
          <div className='mx-auto w-1/2 text-center my-2' style={{color: '#276749'}}>Lovingly made with Chatkit</div>
        </div>
      </Page>
    </div>
  )
